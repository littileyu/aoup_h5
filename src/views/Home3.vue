    ...
    <div class="content">
      ...
      <div class="list" id="list">
        <mt-loadmore :top-method="a" :bottom-method="b" :bottom-all-loaded="c" ref="loadmore">
          <ul id="ul">
            <li v-for="item in 10" @click="openWin('MyAgent')">
              <div class="img">
...
<script>
  export default {
    ...
    mounted() {
      document.getElementById('list').style.height = window.screen.availHeight - 180 - 200 - 40 +'px'
    },
  }
</script>
